...
GET_NEXT = """return $(arguments[0]).next('{selector}')"""
GET_NEXT_ALL = """return $(arguments[0]).next()"""
GET_PREV = """return $(arguments[0]).prev('{selector}')"""
GET_PREV_ALL = """return $(arguments[0]).prev()"""
